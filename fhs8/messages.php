...
$c = $_SESSION['username'];
$records = mysqli_query($db,"SELECT DISTINCT sender
FROM chat where reciever = '$c'"); 
...
?>
  <tr>
    ...
    <td><a href="reply.php?user=<?php echo $data['sender']; ?>"> <?php echo $data['sender']; ?>   </a>sent you a message</td>
